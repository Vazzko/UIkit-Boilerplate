...
var UIKitGenerator = yeoman.generators.Base.extend({
    init: function () {
    ...
    askFor: function () {
        ...
        console.log(chalk.magenta('You\'re using the fantastic UIkit generator. We provide you full JavaScript solution with Sass or Stylus support!'));
        ...
        this.prompt(prompts, function (answers) {
            ...
            this.includeUIKit = hasFeature('includeUIKit');
